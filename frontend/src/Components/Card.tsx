     ...
     <div className='flex flex-col gap-3 border-b'>
      <H3>
        ...
        <div className='flex justify-between'>
          ...
          <IconImage imgsrc={departureIcon} imgwidth={16} imgheight={16} imgalt="Departure Icon"/>
        ...
        <div className='flex justify-between'>
          ...
          <IconImage imgsrc={Seaticon} imgwidth={16} imgheight={16} imgalt="Seat Icon"/>
        ...
        <div className='flex justify-between'>
          ...
          <IconImage imgsrc={Aircrafticon} imgwidth={16} imgheight={16} imgalt="Aircraft Icon"/>
